...
from pytorch_version.dataset import TranslationDataset, paired_collate_fn
from pytorch_version.transformer.Models import Transformer
from pytorch_version.transformer.Optim import ScheduledOptim
...
def main():
    ...
    parser.add_argument('-data', required=False, default="train_val_dict.pkl")
